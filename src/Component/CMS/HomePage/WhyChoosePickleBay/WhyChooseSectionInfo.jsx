...
export default function WhyChooseSectionInfo({ sectionInfo }) {
  ...
  const handleSave = async () => {
    ...
    const updatedFeatures = sectionDetails.steps.map(({ _id, ...rest }) => rest);
    ...
    try {
      ...
      const response = await axiosInstance.post(`${import.meta.env.VITE_BASE_URL}/users/admin/homepage-sections/whyChoosePicklebay`,JSON.stringify(updatedData), config);
    } catch (error) {
