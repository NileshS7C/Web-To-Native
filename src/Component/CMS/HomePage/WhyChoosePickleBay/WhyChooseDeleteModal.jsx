...
export default function WhyChooseDeleteModal({ data, selectedCard, isOpen, onClose, fetchHomepageSections }) {
    const [loading, setLoading] = useState(false);
    const handleDeleteItem = async () => {
        try {
            setLoading(true);
            const updatedFeatures = data
                .filter(step => step.heading !== selectedCard.heading);

            const reindexedFeatures = updatedFeatures.map((step, index) => ({
                ...step,
