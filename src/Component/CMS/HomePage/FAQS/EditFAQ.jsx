...
export default function EditFAQ({ data, selectedCard, isOpen, onClose, fetchHomepageSections }) {
                        ...
                        <Formik
                            ...
                            onSubmit={async (values) => {
                                ...
                                try {
                                    ...
                                    const existingFAQIndex = data.faqs.findIndex(faq => faq.position === newFAQ.position);
                            
                                    let updatedFAQS = [...data.faqs];
                            
                                    if (existingFAQIndex !== -1) {
                                        updatedFAQS[existingFAQIndex] = newFAQ;
                                    } else {
