...
export default function JournalAddDataModal({ data, isOpen, onClose, fetchHomepageSections }) {
    ...
    const uploadImage = async (file) => {
        ...
        myHeaders.append("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3OWNjZjc2N2Y4MmRjOTI5MjkxMzdmNSIsInBob25lIjoiOTk1MzA1MDc2OSIsIm5hbWUiOiJQaWNrbGViYXkgUGxheWVyIiwiaWF0IjoxNzM4NjY1MzUwLCJleHAiOjE3Mzg2NzYxNTB9.hHQ5i2cIHymwP0RWOjbuS_cyaYix3LiQr1wJNPk3Afg");
                                ...
                                try {
                                    ...
                                    if (uploadImageUrl) {
                                        ...
                                        const newFeature = {
                                            ...
                                            position: data.journals.length + 1, // Set next position
                                        };
                            
                                        // Construct the updated features array without `_id`
                                        const updatedFeatures = [...data.journals, newFeature].map(({ _id, ...rest }) => rest);
                                        ...
                                        // Send API request
                                        const response = await fetch("http://localhost:1234/api/admin/homepage-sections/journal", {
                                            method: "PATCH",
                                            headers: myHeaders,
