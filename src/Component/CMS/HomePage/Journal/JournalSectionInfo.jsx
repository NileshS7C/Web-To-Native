...
export default function JournalSectionInfo({ sectionInfo }) {
  ...
  const handleSave = async () => {
    ...
    const updatedFeatures = sectionDetails.journals.map((event) => ({
    ...
    try {
      ...
      const response = await axiosInstance.post(`${import.meta.env.VITE_BASE_URL}/users/admin/homepage-sections/journal`,JSON.stringify(updatedData),config);
    } catch (error) {
