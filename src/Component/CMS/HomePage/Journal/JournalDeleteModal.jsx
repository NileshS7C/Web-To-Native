...
export default function JournalDeleteModal({ data, selectedCard, isOpen, onClose, fetchHomepageSections }) {
    const [loading, setLoading] = useState(false);
    const handleDeleteItem = async () => {
        try {
            setLoading(true);
            const updatedFeatures = data.filter(journal => journal.blogID._id !== selectedCard.blogID._id).map((event) => ({
