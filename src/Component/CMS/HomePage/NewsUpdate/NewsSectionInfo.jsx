...
export default function NewsSectionInfo({ sectionInfo }) {
    ...
    const handleSave = async () => {
        ...
        const updatedFeatures = sectionDetails.news.map(({ _id, ...rest }) => rest);
        ...
        try {
            ...
            const response = await axiosInstance.post(`${import.meta.env.VITE_BASE_URL}/users/admin/homepage-sections/news`,JSON.stringify(updatedData),config);
        } catch (error) {
